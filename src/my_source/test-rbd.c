//compile: 
//gcc -O0 -Wall -g -o test-rbd-3 test-rbd-3.c  -lrbd -lrados
...
int main(int argc, char** argv)
{
   ...
   rt_num = rados_conf_read_file(cluster, "/etc/ceph/ceph2.conf");
   if(rt_num<0){
   ...
   const char* name = "volume-1";
   //const char* name_01 = "3000.img";
