...
class WBThrottle : Thread, public md_config_obs_t
{
     ...
     */
    list<ghobject_t> lru;
    ceph::unordered_map<ghobject_t, list<ghobject_t>::iterator> rev_lru; //# 哈希表加速查找
